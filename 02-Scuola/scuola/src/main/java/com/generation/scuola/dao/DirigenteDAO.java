...
public class DirigenteDAO implements IDAO{
    ...
    public Map<Integer, Entity> read() {
        ...
        try{
            ...
            while(rs.next()){
                ...
                Dirigente e = context.getBean(Dirigente.class, params);
    ...
    public Dirigente readFromId(int idDirigente){
        String query = "select * from persone p inner join dirigenti d on p.id = d.id where d.id = ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
        Dirigente e = null;
        try{
            ps = database.getConnection().prepareStatement(query);
            ps.setInt(1, idDirigente);
            ...
            while(rs.next()){
                ...
                e = context.getBean(Dirigente.class, params);
